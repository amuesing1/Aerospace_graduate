...
def svm_loss_vectorized(W, X, y, reg, delta=1.0):
  ...
  # loss.                                                                     #
  #############################################################################
  gradient_mask=(margins>0)
  gradient_mask=gradient_mask.astype(int)
  gradient_mask[np.arange(y.shape[0]),y]=-np.sum(gradient_mask,axis=1)
  dW=np.dot(X.T,gradient_mask)
